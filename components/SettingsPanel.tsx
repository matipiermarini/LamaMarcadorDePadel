...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  return (
    <div className="absolute top-0 right-0 left-2 z-30 translate-x-full ml-2">
      <button 
      ...
      {isExpanded && (
        <div className="absolute top-12 left-1 right-0 bg-white/95 backdrop-blur-md p-4 rounded-lg shadow-2xl w-96 z-10 border border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input 
                ...
                onChange={(e) => onSetPlayerName('A', 1, e.target.value)} 
                className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-gray-900 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
              />
            </div>
            <div>
              ...
              <input 
                ...
                onChange={(e) => onSetPlayerName('A', 2, e.target.value)} 
                className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-gray-900 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input 
                ...
                onChange={(e) => onSetPlayerName('B', 1, e.target.value)} 
                className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-gray-900 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
              />
            </div>
            <div>
              ...
              <input 
                ...
                onChange={(e) => onSetPlayerName('B', 2, e.target.value)} 
                className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-gray-900 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
              />
            </div>
          </div>
